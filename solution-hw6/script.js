// retrieve the stored cart, if it exists
...
if (storedCart) {
  // If it exists, parse it from JSON and assign it to the cart array
  cart = JSON.parse(storedCart);
} else {
  // If it doesn't exist, create an empty cart array
  cart = [];
}
...
function addToCart() {
  ...
  // display a message to the user to indicate that the item was added to the cart
  alert('Item added to the cart.');

  // Optionally clear the dropdown selections
  glazeDrop.selectedIndex = 0;
  packDrop.selectedIndex = 0;
}
